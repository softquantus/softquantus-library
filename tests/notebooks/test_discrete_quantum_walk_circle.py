...
def test_notebook(tb: TestbookNotebookClient) -> None:
    ...
    ## width-optimized
    # softqlib depths: [419, 749, 1195, 1773, 2499, 3389, 4099]
    expected_depths = [500, 1000, 1500, 2000, 2750, 3500, 4500]
    # softqlib cx_counts: [274, 514, 850, 1298, 1874, 2594, 3194]
    expected_cx_counts = [500, 1000, 1500, 2000, 2750, 3500, 4500]
    # softqlib widths: [6, 7, 8, 9, 10, 11, 13]
    ...
    """
    softqlib depths: [193, 245, 335, 419, 509, 602, 704]
    softqlib cx_counts: [120, 152, 200, 260, 352, 436, 552]
    softqlib widths: [8, 9, 11, 12, 14, 15, 17]
    """
    ## cx-optimized
    # softqlib depths: [193, 245, 335, 419, 509, 602, 704]
