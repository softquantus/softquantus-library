# Contributing to the Softquantus Library
...
- Submitting your research using SoftQLib
- Reporting a bug
- Discussing or improving existing code

We are always available to help — feel free to reach out via [GitHub Discussions](https://github.com/softquantus/softquantus-library/discussions) or the [SoftQLib Slack Community](https://short.softqlib.com/join-slack).
...
4. **Use the Latest SoftQLib Version:**
...
- Use the [`write_qmod`](https://docs.softqlib.com/latest/sdk-reference/modeling/?h=write_qmod#softqlib.write_qmod.write_qmod) function:
...
- The `.metadata.json` file is **not auto-generated**.
  ...
  Example: [bernstein_vazirani_example.metadata.json](https://github.com/softquantus/softquantus-library/blob/main/algorithms/bernstein_vazirani/bernstein_vazirani_example.metadata.json)
...
We use GitHub Issues to track bugs. [Open a new issue](https://github.com/softquantus/softquantus-library/issues/new) and include the following:
...
- Ask questions in [GitHub Discussions](https://github.com/softquantus/softquantus-library/discussions)
- Join the [SoftQLib Slack Community](https://short.softqlib.com/join-slack)
