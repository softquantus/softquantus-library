...
```python
benchmark_hardware = [
    {"provider": "SoftQLib", "backend": "simulator"},
    {"provider": "SoftQLib", "backend": "simulator_statevector"},
