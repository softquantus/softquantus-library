    ...
    *,
    ...
    if backend_service_provider == "IBM Quantum":
        ...
        return IonqBackendPreferences(
            backend_name=backend_name,
            run_via_softqlib=True,
        )

    elif backend_service_provider == "Amazon Braket":
        return AwsBackendPreferences(
            backend_name=backend_name, run_via_softqlib=True, emulate=emulate
        )
    ...
    elif backend_service_provider == "SoftQLib":
        return SoftQLibBackendPreferences(
            backend_name=backend_name,
        )
